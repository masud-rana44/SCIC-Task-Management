  ...
  return (
    <section className="py-10 bg-gray-100 text-slate-600 dark:bg-slate-700 dark:text-gray-100 sm:pt-16 lg:pt-24">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 container">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            ...
            <p className="text-base leading-relaxed text-gray-600 dark:text-gray-400 mt-7">
              Efficient task management made simple. Our website offers
              intuitive tools, seamless organization, and collaborative features
              for streamlined productivity and effective project handling.
            </p>
        ...
        <hr className="mt-16 mb-10 border-gray-200 dark:border-slate-600" />

        <p className="text-sm text-center text-gray-600 dark:text-gray-400">
          © Copyright 2021, All Rights Reserved by GadgetHub
        </p>
      </div>
    </section>
  );
